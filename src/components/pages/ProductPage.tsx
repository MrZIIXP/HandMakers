	...
	const reviews = [
		{
			...
			date: '2024-02-15',
			comment:
				'Отличное качество! Очень довольна покупкой. Упаковано аккуратно, доставили быстро.',
			avatar:
		...
		},
		{
			...
			date: '2024-02-10',
			comment:
				'Превосходная работа мастера! Именно то, что искал. Рекомендую всем.',
			avatar:
							...
							<CardContent className='p-4'>
								<div className='flex items-center space-x-4'>
									...
									<div className='flex-1'>
										<button
											onClick={() =>
												onNavigate('seller', { sellerId: seller.id })
											}
							...
							<Card>
								<CardContent className='p-6'>
									...
									<div className='mt-6 space-y-2'>
										<p>
											<strong>Материал:</strong> Высококачественная керамика
										</p>
										<p>
											<strong>Техника изготовления:</strong> Ручная лепка
										</p>
										<p>
											<strong>Время изготовления:</strong> 3-5 дней
										</p>
										<p>
											<strong>Уход:</strong> Мыть теплой водой без абразивных
											средств
										</p>
									</div>
								</CardContent>
								...
								<CardContent className='p-6'>
									<div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
										<div className='space-y-3'>
											<div>
												<span className='font-medium'>Размеры:</span> 20 x 15 см
											</div>
											<div>
												<span className='font-medium'>Вес:</span> 800 г
											</div>
											<div>
												<span className='font-medium'>Цвет:</span> Натуральный
											</div>
										</div>
										<div className='space-y-3'>
											<div>
											...
											<div>
												<span className='font-medium'>Гарантия:</span> 6 месяцев
											</div>
											<div>
												<span className='font-medium'>Артикул:</span> VAS-
												{product.id}
											</div>
										</div>
									</div>
